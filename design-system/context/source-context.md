...
Canonical design-system title: Fellowship Focus — app Design System

Fellowship Focus — app Windows de productivité pour freelances et devs qui bossent en guild (accountability sociale).

Mission : bloquer les distractions (Twitter, YouTube Shorts, TikTok) pendant des sessions focus 45 min, tracker XP/habits/OKRs avec des amis — sans surveillance agressive.

Voix : calme, professionnelle, minimaliste. Pas fantasy RPG, pas gold partout. Think Linear × Opal × Notion — dark, clean, data-first.

Utilisateur : dev/freelance 25–40 ans, Windows, veut un dashboard qui respire, pas un jeu vidéo.

Interdits UI : JSON/token visible, debug text, hero banners vides, double sidebar, serif sur les chiffres, boutons gold gradient pleine largeur.

Références visuelles : Linear app, Opal, Raycast, Vercel dashboard — pas Lord of the Rings UI kits.

## Source Links

- https://github.com/lezardoloris/fellowship-focus
...
1. For each linked repository, run the bounded intake command before writing design-system files. The command tries this-device access first (`git clone`, then authenticated GitHub CLI via `gh auth login --web`) and uses the Composio GitHub connector only as a connector-platform fallback.
   - `"$OD_NODE_BIN" "$OD_BIN" tools connectors github-design-context --repo 'https://github.com/lezardoloris/fellowship-focus' --output context/github/lezardoloris-fellowship-focus.md`
...
- image-849fd06f-2275-451f-8136-c2c51c0c7ef7.png
- image-63b4e59b-9f50-46e9-9221-c27528f62001.png
- image-32246d42-17de-4791-ae4e-0f73bdc3a2ab.png
- image-7916f200-8d30-4d4f-bc91-48fd5722e638.png
- image-cb380d40-d350-43ff-9757-455eb839fd06.png
- image-9517ad37-ee70-4ce2-92b9-6ab4d82df9c0.png

Uploaded brand asset files under `assets/`:
- assets/image-849fd06f-2275-451f-8136-c2c51c0c7ef7.png
- assets/image-63b4e59b-9f50-46e9-9221-c27528f62001.png
- assets/image-32246d42-17de-4791-ae4e-0f73bdc3a2ab.png
- assets/image-7916f200-8d30-4d4f-bc91-48fd5722e638.png
- assets/image-cb380d40-d350-43ff-9757-455eb839fd06.png
- assets/image-9517ad37-ee70-4ce2-92b9-6ab4d82df9c0.png
