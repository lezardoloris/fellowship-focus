...
/**
 * Default playlist order: preferred tracks first (user-curated), then the rest of
 * the library. Index 0 is the default pick when nothing is saved.
 */
export const FOCUS_TRACKS: FocusTrack[] = [
  ...
  },
  {
    id: "wh40k-immortal",
    title: "Immortal",
    channel: "Dream Clinic",
    duration: "1:00:00",
    vibe: "ambient",
    youtubeId: "Ykem_yAFh2A",
    trimStart: 10,
    trimEnd: 14,
  },
  {
  ...
  {
    id: "wh40k-still-loyal",
    title: "Still Loyal",
    channel: "Fantasy Future",
    duration: "1:06:21",
    vibe: "cinematic",
    youtubeId: "k_YK5V2WxIA",
    trimStart: 10,
    trimEnd: 14,
  },
  {
  ...
  // ── Remaining library (after preferred defaults) ──
  {
    id: "ceo-penthouse",
    title: "CEO Penthouse",
  ...
  {
    id: "wh40k-monastery",
    title: "Dark Monastery",
    channel: "Prometheus Studio",
    duration: "1:19:45",
    vibe: "ambient",
    youtubeId: "VWGr_89_xdU",
    trimStart: 10,
    trimEnd: 14,
  },
  {
    id: "wh40k-chaos-ritual",
    title: "Chaos Ritual",
    channel: "Prometeo Ambient Music",
    duration: "1:00:17",
    vibe: "ambient",
    youtubeId: "MDy0IrSJrlM",
    trimStart: 8,
    trimEnd: 12,
  },
  {
    id: "wh40k-holy-terra",
    title: "Holy Terra",
    channel: "Domains of Ambience",
    duration: "3:00:40",
    vibe: "classical",
    youtubeId: "k5xDyG72wHE",
    trimStart: 10,
    trimEnd: 14,
  },
  {
